...
def validateUsableBatteries(usableBatteries):
	...
	powerCapacity = [min(config.Battery1.chargeState,config.Battery1.maxPower)*usableBatteries[0],
					min(config.Battery2.chargeState,config.Battery2.maxPower)*usableBatteries[1],
					min(config.Battery3.chargeState,config.Battery3.maxPower)*usableBatteries[2],
					min(config.Battery4.chargeState,config.Battery4.maxPower)*usableBatteries[3],
					min(config.Battery5.chargeState,config.Battery5.maxPower)*usableBatteries[4],
					min(config.Battery6.chargeState,config.Battery6.maxPower)*usableBatteries[5],
					min(config.Battery7.chargeState,config.Battery7.maxPower)*usableBatteries[6],
					min(config.Battery8.chargeState,config.Battery8.maxPower)*usableBatteries[7],
					min(config.Battery9.chargeState,config.Battery9.maxPower)*usableBatteries[8],
					min(config.Battery10.chargeState,config.Battery10.maxPower)*usableBatteries[9],
					min(config.Battery11.chargeState,config.Battery11.maxPower)*usableBatteries[10],
					min(config.Battery12.chargeState,config.Battery12.maxPower)*usableBatteries[11],
					min(config.Battery13.chargeState,config.Battery13.maxPower)*usableBatteries[12],
					min(config.Battery14.chargeState,config.Battery14.maxPower)*usableBatteries[13],
					min(config.Battery15.chargeState,config.Battery15.maxPower)*usableBatteries[14],
					min(config.Battery16.chargeState,config.Battery16.maxPower)*usableBatteries[15],
					min(config.Battery17.chargeState,config.Battery17.maxPower)*usableBatteries[16],
					min(config.Battery18.chargeState,config.Battery18.maxPower)*usableBatteries[17],
					min(config.Battery19.chargeState,config.Battery19.maxPower)*usableBatteries[18],
					min(config.Battery20.chargeState,config.Battery20.maxPower)*usableBatteries[19],
					min(config.Battery21.chargeState,config.Battery21.maxPower)*usableBatteries[20],
					min(config.Battery22.chargeState,config.Battery22.maxPower)*usableBatteries[21],
					min(config.Battery23.chargeState,config.Battery23.maxPower)*usableBatteries[22],
					min(config.Battery24.chargeState,config.Battery24.maxPower)*usableBatteries[23],
					min(config.Battery25.chargeState,config.Battery25.maxPower)*usableBatteries[24],
					min(config.Battery26.chargeState,config.Battery26.maxPower)*usableBatteries[25],
					min(config.Battery27.chargeState,config.Battery27.maxPower)*usableBatteries[26],
					min(config.Battery28.chargeState,config.Battery28.maxPower)*usableBatteries[27],
					min(config.Battery29.chargeState,config.Battery29.maxPower)*usableBatteries[28],
					min(config.Battery30.chargeState,config.Battery30.maxPower)*usableBatteries[29],
					min(config.Battery31.chargeState,config.Battery31.maxPower)*usableBatteries[30],
					min(config.Battery32.chargeState,config.Battery32.maxPower)*usableBatteries[31],
					min(config.Battery33.chargeState,config.Battery33.maxPower)*usableBatteries[32],
					min(config.Battery34.chargeState,config.Battery34.maxPower)*usableBatteries[33],
					min(config.Battery35.chargeState,config.Battery35.maxPower)*usableBatteries[34],
					min(config.Battery36.chargeState,config.Battery36.maxPower)*usableBatteries[35],
					min(config.Battery37.chargeState,config.Battery37.maxPower)*usableBatteries[36],
					min(config.Battery38.chargeState,config.Battery38.maxPower)*usableBatteries[37],
					min(config.Battery39.chargeState,config.Battery39.maxPower)*usableBatteries[38],
					min(config.Battery40.chargeState,config.Battery40.maxPower)*usableBatteries[39],
					min(config.Battery41.chargeState,config.Battery41.maxPower)*usableBatteries[40],
					min(config.Battery42.chargeState,config.Battery42.maxPower)*usableBatteries[41],
					min(config.Battery43.chargeState,config.Battery43.maxPower)*usableBatteries[42],
					min(config.Battery44.chargeState,config.Battery44.maxPower)*usableBatteries[43],
					min(config.Battery45.chargeState,config.Battery45.maxPower)*usableBatteries[44],
					min(config.Battery46.chargeState,config.Battery46.maxPower)*usableBatteries[45],
					min(config.Battery47.chargeState,config.Battery47.maxPower)*usableBatteries[46],
					min(config.Battery48.chargeState,config.Battery48.maxPower)*usableBatteries[47],
					min(config.Battery49.chargeState,config.Battery49.maxPower)*usableBatteries[48],
					min(config.Battery50.chargeState,config.Battery50.maxPower)*usableBatteries[49]]
